    ...
    '<ul>' +
        ...
        '<li>' +
            '<div class="theme-color">' +
                ...
                '<a href="#" data-toggle="tooltip" title="Dark Navbar" class="navbar-theme waves-effect waves-light" navbar-theme="theme2"><span class="head"></span><span class="cont"></span></a>' +
        ...
        '<ul>' +
            ...
            '<li class="theme-option">' +
                '<div class="theme-color">' +
                    ...
                    '<a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme20">&nbsp;</a>' +
                    '<a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme21">&nbsp;</a>' +
                    '<a href="#" class="active-item-theme small waves-effect waves-light" active-item-theme="theme22">&nbsp;</a>' +
                '</div>' +
            '</li>' +
            '<li>' +
