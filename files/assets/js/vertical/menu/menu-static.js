...
$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        ThemeBackgroundPattern: 'theme2',  // pattern1, pattern2, pattern3, pattern4, pattern5, pattern6
        HeaderBackground: 'theme2',  // theme2, theme2, theme3, theme4, theme5  header color
        LHeaderBackground: 'theme2', // theme2, theme2, theme3, theme4, theme5, theme6   brand color
        NavbarBackground: 'themelight1', // themelight1, theme2  // light  and dark sidebar
        ActiveItemBackground: 'theme2', // theme2, theme2, theme3, theme4, theme5, theme6, theme7, theme8, theme9, theme20, theme21, theme22  mennu active item color
    ...
    function handlelayouttheme() {
        $('.theme-color > a.Layout-type').on("click", function () {
            ...
            if(layout=='dark'){
                ...
                $('.pcoded-navbar').attr("navbar-theme", "theme2");
